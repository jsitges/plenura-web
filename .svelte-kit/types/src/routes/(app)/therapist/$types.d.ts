...
type LayoutRouteId = RouteId | "/(app)/therapist" | "/(app)/therapist/availability" | "/(app)/therapist/bookings" | "/(app)/therapist/earnings" | "/(app)/therapist/profile" | "/(app)/therapist/services" | "/(app)/therapist/subscription"
