...
type LayoutRouteId = RouteId | "/" | "/(app)/booking/[id]/confirmation" | "/(app)/booking/[id]/review" | "/(app)/booking/new" | "/(app)/bookings" | "/(app)/dashboard" | "/(app)/favorites" | "/(app)/referrals" | "/(app)/therapist" | "/(app)/therapist/availability" | "/(app)/therapist/bookings" | "/(app)/therapist/earnings" | "/(app)/therapist/profile" | "/(app)/therapist/services" | "/(app)/therapist/subscription" | "/(app)/therapists" | "/(app)/therapists/[id]" | "/(auth)/login" | "/(auth)/register" | "/(auth)/register/confirm" | null
